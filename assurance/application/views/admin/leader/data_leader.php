					...
					<?php if ($this->session->flashdata('success_update')): ?>
				        ...
				        <div class="card mb-4">
                            ...
                            <div class="card-header">
						        ...
						        <!-- <a href="<?php echo site_url('leader/add') ?>"><i class="fas fa-plus"></i> Add New</a> -->
						        ...
						        <div class="table-responsive">
							        ...
							        <table  class="table m-table table-sm table-striped table-bordered  table-hover" id="dataTable" width="100%" cellspacing="0">
								        ...
								        <tbody>
									        ...
									        <?php $num = 1; foreach ($leader as $leader): ?>
									        ...
									        <tr>
										        ...
										        <td width="250">
											        ...
											        <a href="<?php echo site_url('leader/edit/'.$leader->id) ?>"

											        class="btn btn-small"><i class="fas fa-edit"></i>Edit</a>

											        <!-- <a onclick="deleteConfirm('<?php echo site_url('leader/delete/'.$leader->id) ?>')"
